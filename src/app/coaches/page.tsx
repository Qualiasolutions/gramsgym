...
const coaches = [
  {
    ...
    experience: '10+ years',
    bio: 'Expert in building strength and muscle with a passion for helping clients achieve their fitness goals through personalized training programs.',
  ...
  },
  {
    ...
    experience: '8+ years',
    bio: 'Specializes in body transformations through personalized nutrition and high-intensity training. Dedicated to helping members achieve their weight loss goals.',
    certifications: ['Fitness Instructor', 'Nutrition Coach'],
  },
  {
    id: 3,
    name: 'Amro Alrashed',
    ...
    experience: '7+ years',
    bio: 'Focused on helping clients achieve peak physical performance through structured training programs and athletic conditioning.',
    certifications: ['Sports Coach', 'Functional Training'],
  },
  {
    id: 4,
    name: 'Ahmad Alrashed',
    ...
    experience: '6+ years',
    bio: 'Passionate about making fitness accessible and enjoyable for everyone. Specializes in helping beginners build confidence and establish healthy habits.',
    certifications: ['Personal Trainer', 'Group Fitness'],
  },
]
